...
/*
 * The `LAYOUT_vulpes_majora_base` macro is a template to allow the use of identical
...
#define LAYOUT_vulpes_majora_base( \
  ...
  LAYOUT_wrapper( \
        ...
        KC_MS_BTN2,      K21,            K22,            K23,            K24,                    K25,                                                                       K26,                   K27,                   K28,              K29,            K2A,          FP_SNIPE_TOG,  \
                                                         K33,            LT(_NAVIGATION,K34),    LT(_FUNCTION,K35),          KC_MS_BTN3, KC_MS_BTN1, KC_MS_BTN2,            LT(_MEDIA,K36),        LT(_SYMBOLS,K37),      K38,                                                           \
...
#define LAYOUT_vulpes_majora_base_wrapper(...)       LAYOUT_vulpes_majora_base(__VA_ARGS__)

const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {

    [_ALPHA_ALT] = LAYOUT_vulpes_majora_base_wrapper(
    ...
    [_ALPHA] = LAYOUT_vulpes_majora_base_wrapper(
    ...
    [_NAVIGATION] = LAYOUT_wrapper(
        ...
        _______, ________________NAVIGATION_3_______________,                                  _________________NUMPAD_3__________________, _______,
                                    _______, _______, KC_TAB,    _______, _______, _______,    KC_BSPC, KC_SPACE, KC_DOT,
                 KC_VOLU,           _______, _______, _______,                                 _______, _______, _______,          KC_VOLU,
        KC_MPRV, KC_MPLY, KC_MNXT,                                                                                        KC_MPRV, KC_MPLY, KC_MNXT,
                 KC_VOLD,                                                                                                          KC_VOLD
    ),
    ...
    [_SYMBOLS] = LAYOUT_wrapper(
        ...
        _______, ________________SYMBOLS_L3_________________,                                  ________________SYMBOLS_R3_________________, _______,
                                    _______, KC_ENT, KC_DEL,     _______, _______, _______,    KC_BSPC, _______, _______,
                 KC_VOLU,           _______, _______, _______,                                 _______, _______, _______,          KC_VOLU,
        KC_MPRV, KC_MPLY, KC_MNXT,                                                                                        KC_MPRV, KC_MPLY, KC_MNXT,
                 KC_VOLD,                                                                                                          KC_VOLD
    ),
    ...
    [_FUNCTION] = LAYOUT_wrapper(
        ...
        _______, ________________SHIFTNAV_3_________________,                                  ________________FUNCTION_3_________________, _______,
                                   _______, _______, _______,    _______, _______, _______,    N_DEL_LINE, KC_SPACE, _______,
                 KC_VOLU,          _______, _______, _______,                                  _______, _______, _______,          KC_VOLU,
        KC_MPRV, KC_MPLY, KC_MNXT,                                                                                        KC_MPRV, KC_MPLY, KC_MNXT,
                 KC_VOLD,                                                                                                          KC_VOLD
    ),
